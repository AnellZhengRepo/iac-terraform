...
variable "bucket_names_list" {
  description = "List of S3 bucket to create"
  type        = list(string)
  default     = ["tf-s3-example-practice-list", "tf-s3-example-test-list"]
}

variable "bucket_names_set" {
  description = "List of S3 bucket to create"
  type        = set(string)
  default     = ["tf-s3-example-practice-set", "tf-s3-example-test-set"]
}

variable "generic_resource_tags" {
